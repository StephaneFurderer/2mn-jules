...
from policy_count_forecast.core import (
    get_training_cohorts,main_pol_cohorts_development,calculate_month_difference,_forecast_pol,forecast_policy_count,load_data,get_gcp_per_pol_from_finance,save_data,get_or_create_config_for_key,save_data_tm)
...
block = st.sidebar.selectbox("CSA/TM",["CSA","TM"],index=1)
...
if block == "CSA":
    ...
    past_future_pol_cohorts, per_app_date_ = forecast_policy_count(policies_seg=policies_seg
                                                                ,segment=segment
    ...
    tab0, tab1, tab3 = st.tabs(["Final Policy Count Forecasts","Financial Assumptions","Policy Count Forecasts"])
    with tab0:
